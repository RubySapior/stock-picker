  ...
  "meta": {
    ...
    "limits": {
      ...
      "rebalance": {
        ...
        "note": "Quarterly audit (v5.4): once per calendar quarter (first market-open run of Jan/Apr/Jul/Oct), update.py compares each sector's EFFECTIVE exposure against these targets and flags anything beyond tolerance_pct (+/-5pp). It NEVER trades - it only asks the conviction layer to review the risk-budget mismatch. No daily pp-drift flags."
      },
      "position_exposure": {
        "TQQQ": {
